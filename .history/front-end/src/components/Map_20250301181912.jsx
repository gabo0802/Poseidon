...
{
  "Alachua County": ["Gainesville", "Alachua", "High Springs", "Newberry", "Waldo"],
  "Baker County": ["Macclenny", "Glen St. Mary", "Sanderson", "Olustee"],
  "Bay County": ["Panama City", "Lynn Haven", "Callaway", "Parker", "Mexico Beach"],
  "Bradford County": ["Starke", "Lawtey", "Hampton", "Brooker"],
  "Brevard County": ["Cocoa", "Melbourne", "Palm Bay", "Titusville", "Rockledge"],
  "Broward County": ["Fort Lauderdale", "Hollywood", "Pembroke Pines", "Miramar", "Pompano Beach", "Coral Springs", "Davie"],
  ...
  "Franklin County": ["Apalachicola", "Carrabelle", "Eastpoint", "St. George Island"],
  ...
  "Hillsborough County": ["Tampa", "Brandon", "Temple Terrace", "Plant City", "Ruskin"],
  ...
  "Lee County": ["Fort Myers", "Cape Coral", "Lehigh Acres", "Bonita Springs", "Sanibel", "Estero"],
  ...
  "Miami-Dade County": ["Miami", "Hialeah", "Miami Beach", "Homestead", "Coral Gables", "Aventura", "Doral", "North Miami"],
  "Monroe County": ["Key West", "Marathon", "Tavernier", "Islamorada"],
  "Nassau County": ["Fernandina Beach", "Yulee", "Callahan"],
  "Okaloosa County": ["Fort Walton Beach", "Destin", "Niceville", "Crestview", "Valparaiso"],
  "Okeechobee County": ["Okeechobee", "Basswood", "Basinger"],
  "Orange County": ["Orlando", "Winter Park", "Apopka", "Ocoee", "Maitland", "Lake Buena Vista"],
  "Osceola County": ["Kissimmee", "St. Cloud", "Poinciana", "Harmony"],
  "Palm Beach County": ["West Palm Beach", "Boca Raton", "Delray Beach", "Lake Worth", "Jupiter", "Boynton Beach", "Palm Springs"],
  "Pasco County": ["New Port Richey", "Dade City", "Zephyrhills", "Hudson", "Port Richey"],
  "Pinellas County": ["St. Petersburg", "Clearwater", "Pinellas Park", "Dunedin", "Largo", "Palm Harbor"],
  "Polk County": ["Lakeland", "Winter Haven", "Bartow", "Lake Wales", "Auburndale", "Mulberry", "Haines City"],
  ...
  "Sarasota County": ["Sarasota", "Venice", "North Port", "Osprey", "Englewood"],
  "Seminole County": ["Sanford", "Altamonte Springs", "Casselberry", "Longwood", "Lake Mary", "Winter Springs"],
  "Sumter County": ["Bushnell", "Wildwood", "The Villages"],
  "Taylor County": ["Perry", "Shady Grove", "Steinhatchee"],
  "Union County": ["Lake Butler"],
  "Volusia County": ["Daytona Beach", "Deltona", "Ormond Beach", "New Smyrna Beach", "Edgewater"],
  "Wakulla County": ["Crawfordville", "Panacea", "St. Marks"],
  "Walton County": ["DeFuniak Springs", "Santa Rosa Beach", "Freeport", "Miramar Beach"],
