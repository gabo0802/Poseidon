...
const geoUrl =
  "https://raw.githubusercontent.com/topojson/topojson-datasets/master/ne_110m_admin_0_countries.json";
...
const Map = () => {
  ...
  const findCountyByCity = (city) => {
    return cityToCountyMap[city] || null; // Returns the county name or null if not found
  };
