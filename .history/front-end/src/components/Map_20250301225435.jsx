...
function Map() {
  ...
  const handleMouseEnter = (event, countyName) => {
    ...
    setTooltipPosition({ x: clientX, y: clientY }); // Set mouse position directly for tooltip placement
      ...
      <div className="w-4/5 h-4/5 relative">
        ...
        {tooltipContent && (
          <div
            ...
            style={{
              left: `${tooltipPosition.x + 10}px`, // Add a slight offset for better positioning
              top: `${tooltipPosition.y + 10}px`, // Add a slight offset for better positioning
