...
function Map() {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center overflow-hidden  style={{
    background: "linear-gradient(to top right, #589FE0 30%, #ffffff 80%)", // Gradient from bottom left to top right
  }}
      >
