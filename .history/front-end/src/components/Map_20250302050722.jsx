          ...
          >
            ...
            {floodData ? (
              <>
                ...
                <p>
                  <strong>Min Temp (°C):</strong> {floodData["min_temp (°C)"]}
                </p>
                <p>
                  <strong>Max Temp (°C):</strong> {floodData["max_temp (°C)"]}
                </p>
                <p>
                  <strong>Avg Temp (°C):</strong> {floodData["avg_temp (°C)"]}
                </p>
                <p>
                ...
                <p>
                  <strong>Rainfall (mm):</strong> {floodData["rainfall (mm)"]}
                </p>
                <p>
