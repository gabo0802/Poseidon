  ...
  return (
    <footer className="footer">
      <div className="w-full h-[138px] relative">
        ...
        <div className="w-[90px] h-[90px] left-10 bg-gradient-to-r from-[#ff5202] to-[#ff8f5c] opacity-90 rounded-full absolute"></div>
        <img
          className="w-[80px] h-[80px] relative bottom-[2px] left-10"
