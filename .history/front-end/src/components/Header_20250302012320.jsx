    ...
    <header className="header">
      <div className="w-full h-[138px] relative">
        ...
        <div className="w-[1007px] h-[38px] left-[173px] top-[57px] absolute">
          ...
          <h3 className="left-3 top-0 text-3xl absolute text-black font-bold font-['Poppins']">
            P<span className="bg-white bg-clip-text text-transparent">o</span>
            seid
            <span className="bg-white bg-clip-text text-transparent">o</span>n
          </h3>
