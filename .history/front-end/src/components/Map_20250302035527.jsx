...
function Map() {
  ...
  // Handle scroll event to show or hide the search box
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 300) {
        // Change 300 to the scroll position where you want to show the box
        setIsVisible(true);
      } else {
        setIsVisible(false);
      }
  ...
  return (
    ...
    >
      <motion.div
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: isVisible ? 1 : 0.1 }} // Change opacity based on scroll
