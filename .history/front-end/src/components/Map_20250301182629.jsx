...
function Map() {
  ...
  const handleKeyPress = (event) => {
    if (event.key === "Enter") {
      const counties = getCountyByCity(searchTerm);
    ...
    <>
      <div className="w-screen h-screen bg-white flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="w-3/5 my-4">
          ...
          type="text" placeholder="Search..." className="w-full p-1 border
          border-gray-300 rounded" value={searchTerm}
