    ...
    <header className="header shadow-lg">
      <div className="w-full h-[138px] relative">
        ...
        <div className="w-[1007px] h-[38px] left-[173px] top-[57px] absolute">
          ...
          <h3 className="right-[200px] top-[2px] text-black font-bold absolute font-['Poppins'] hover:underline hover:cursor-pointer hover:scale-105 transition-transform">
            Description
          </h3>
          <h3 className="right-[0px] top-[2px] text-black font-bold absolute font-['Poppins'] hover:underline hover:cursor-pointer hover:scale-105 transition-transform">
            Flood Map
          </h3>
        </div>
