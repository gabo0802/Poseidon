    ...
    <>
      ...
      >
        <div className="headingContainer">
          <h1 className="heading">See your Communityyy</h1>
        </div>
        <ComposableMap
          projection="geoAlbersUsa" // Use a projection that suits your needs (geoAlbersUsa is often used for U.S. maps)
          projectionConfig={{
            scale: 1500, // Increase the scale to make the map objects larger
            translate: [250, 200], // Adjust translation to center the map as needed
          }}
        >
