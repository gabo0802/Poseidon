...
export default function Header() {
    return(
        <header className="header">
            ...
            <div className="w-full h-[138px] left-0 top-0 absolute bg-[#0825fb]/70 border border-black" />
            ...
            <img className="w-[63px] h-[63px] left-[94px] top-[31px] absolute" src="src/assets/presidon-logo.png"/>
            </div>
        </header>
    )
}